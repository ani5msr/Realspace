...
data-toggle="collapse" data-target="#bs-example-navbarcollapse-1" aria-expanded="false">
 ...
 <img src="images/bullhornlogo50x50.png" alt="Bullhorn
Logo"/>&nbsp;<h2>Realspace</h2>
 </div>
...
placeholder="Search" name="searchtext">
 ...
 <li><a href="ProfileServlet?userid=${user.bhuserid}&act
ion=viewprofile"><img alt="${user.username}" src="${gra
vatarURL}"/>&nbsp;${user.username}</a></li>
 <% } %>
 <li class="dropdown">
...
Options <span class="caret"></span></a>
 ...
 <li>
 <!-- <li><a href="LoginServlet?action=logout">Log
out</a></li>-->
 <!-- Bootstrap allows me to put a form here and
it will show in the navbar.
 I want to use a form so it can call the
...
id="addBookButton">Logout</button>
 ...
 <li><a href="Newsfeed?userid=${user.bhuserid }">
Show my Posts</a></li>
 <li><a href="ProfileServlet?userid=${user.bhuserid }
&action=editprofile">Edit Profile</a></li>
